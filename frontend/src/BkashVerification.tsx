...
function BkashVerification({ onVerify, onClose, amount }: BkashVerificationProps) {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ color: '#64748b', fontSize: '0.9rem' }}>Send to:</span>
                <span style={{ 
                  color: '#e2136e', 
                  fontWeight: '700', 
                  fontSize: '1rem',
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                    ...
                    <span style={{ color: '#475569', fontSize: '0.9rem' }}>
                      Go to <strong>Send Money</strong>
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                    <span style={{
                    ...
                    <span style={{ color: '#475569', fontSize: '0.9rem' }}>
                      Enter: <strong style={{color: '#e2136e'}}>01766325020</strong>
                    </span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                    <span style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
                    ...
                    <span style={{ color: '#475569', fontSize: '0.9rem' }}>
                      Enter <strong>PIN</strong> & copy <strong>TrxID</strong>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ marginTop: '6px' }}>
                  <strong>TrxID:</strong> <span style={{
                    color: '#e2136e',
                    backgroundColor: '#fff1f8',
                    padding: '4px 8px',
                    borderRadius: '4px',
              ...
              <div style={{
                ...
                Copy the <strong>TrxID</strong> and paste below
              </div>
            </div>
              ...
              <div style={{ marginBottom: '20px' }}>
                <div style={{
                  ...
                  <button 
                    ...
                    onMouseOver={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(135deg, #c91163, #b6025f)';
                      e.currentTarget.style.transform = 'translateY(-1px)';
                    }}
                    onMouseOut={(e) => {
                      e.currentTarget.style.background = 'linear-gradient(135deg, #e2136e, #d70270)';
                ...
                <div style={{ position: 'relative', marginBottom: '8px' }}>
                  <input
                    ...
                    placeholder="Enter TrxID (e.g., 8G7H9J2K4L5M)"
                    disabled={isVerified}
                    style={{
                      width: '100%',
                      padding: '16px',
                    ...
                    onFocus={(e) => {
                      if (!isVerified) {
                        ...
                        e.target.style.boxShadow = '0 0 0 3px rgba(226, 19, 110, 0.1)';
                      }
                    }}
                    onBlur={(e) => {
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <ul style={{
                      ...
                      <li>Send exact amount: <strong>৳{amount || 0}</strong></li>
                      <li>To number: <strong>01766325020</strong></li>
                      <li>Delivery: Within 60 seconds after verification</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div style={{
          ...
          <button 
            ...
            style={{
              width: '100%',
              padding: '18px',
              background: !transactionId.trim() || isVerified 
                ? '#cbd5e1' 
              ...
              fontSize: '1.1rem',
              fontWeight: '700',
              cursor: !transactionId.trim() || isVerified ? 'not-allowed' : 'pointer',
              transition: 'all 0.3s ease',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              gap: '10px',
              boxShadow: !transactionId.trim() || isVerified 
                ? 'none' 
            ...
            onMouseOver={(e) => {
              if (transactionId.trim() && !isVerified) {
                ...
                e.currentTarget.style.boxShadow = '0 8px 24px rgba(226, 19, 110, 0.4)';
              }
            }}
            onMouseOut={(e) => {
              if (transactionId.trim() && !isVerified) {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 6px 20px rgba(226, 19, 110, 0.3)';
              }
            }}
          >
            {isVerified ? (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ color: '#475569', fontSize: '0.95rem' }}>Transaction ID:</span>
                <strong style={{ 
                  color: '#065f46', 
                  fontSize: '1rem',
                  fontFamily: "'Courier New', monospace"
                }}>{transactionId}</strong>
              </div>
              <div style={{
                display: 'flex',
                alignItems: 'center',
                ...
                <span style={{ color: '#475569', fontSize: '0.95rem' }}>Amount:</span>
                <strong style={{ color: '#065f46', fontSize: '1.1rem' }}>৳{amount || 0}</strong>
              </div>
              <div style={{
                display: 'flex',
                alignItems: 'center',
                ...
                <span style={{ color: '#475569', fontSize: '0.95rem' }}>Time:</span>
            ...
            <div style={{
              ...
              <p style={{
                ...
                fontWeight: '600',
                fontSize: '1rem'
              }}>✅ Payment verified successfully!</p>
              <p style={{
                color: '#059669',
                margin: '0',
                fontSize: '0.9rem',
                ...
                Your diamonds will be delivered to your Free Fire account within 60 seconds.
              </p>
            </div>
